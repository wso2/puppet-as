...
1. Clone WSO2 AS Puppet modules Git repository and consider this path as `PUPPET_HOME`:

    ````
    git clone https://github.com/wso2/puppet-as.git
    ````
...
5. Download and copy WSO2 AS distribution (5.3.0) to Puppet module under `files` folder:
